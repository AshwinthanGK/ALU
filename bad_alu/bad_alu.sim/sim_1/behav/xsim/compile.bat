...
REM
REM Generated by Vivado on Thu Jan 29 15:47:00 +0530 2026
...
echo "xvlog --incr --relax -prj tb_ALU_ME_vlog.prj"
call xvlog  --incr --relax -prj tb_ALU_ME_vlog.prj -log xvlog.log
