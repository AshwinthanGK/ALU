...
REM
REM Generated by Vivado on Sun Feb 22 13:50:21 +0530 2026
...
echo "xvlog --incr --relax -prj tb_ALU_GL_Top_vlog.prj"
call xvlog  --incr --relax -prj tb_ALU_GL_Top_vlog.prj -log xvlog.log
