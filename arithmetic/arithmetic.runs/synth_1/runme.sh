...
HD_PWD='C:/Users/gkash/Verilog files/arithmetic/arithmetic.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log signed_calc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source signed_calc.tcl
