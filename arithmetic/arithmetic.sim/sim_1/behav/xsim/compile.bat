...
REM
REM Generated by Vivado on Tue Jan 06 13:21:54 +0530 2026
...
echo "xvlog --incr --relax -prj tb_signed_calc_vlog.prj"
call xvlog  --incr --relax -prj tb_signed_calc_vlog.prj -log xvlog.log
