...
REM
REM Generated by Vivado on Wed Jan 07 16:29:41 +0530 2026
...
echo "xvlog --incr --relax -prj TB_FBFA_vlog.prj"
call xvlog  --incr --relax -prj TB_FBFA_vlog.prj -log xvlog.log
