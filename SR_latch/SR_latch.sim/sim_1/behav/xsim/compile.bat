...
REM
REM Generated by Vivado on Thu Jan 15 18:44:47 +0530 2026
...
echo "xvlog --incr --relax -prj Simulate_SR_vlog.prj"
call xvlog  --incr --relax -prj Simulate_SR_vlog.prj -log xvlog.log
