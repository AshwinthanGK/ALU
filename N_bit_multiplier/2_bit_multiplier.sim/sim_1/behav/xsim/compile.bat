...
REM
REM Generated by Vivado on Tue Jan 20 11:02:55 +0530 2026
...
echo "xvlog --incr --relax -prj NxNStructMult_vlog.prj"
call xvlog  --incr --relax -prj NxNStructMult_vlog.prj -log xvlog.log
