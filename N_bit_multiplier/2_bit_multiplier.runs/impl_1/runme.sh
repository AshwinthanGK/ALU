...
HD_PWD='C:/Users/gkash/Verilog files/2_bit_multiplier/2_bit_multiplier.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TwoBMult.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TwoBMult.tcl -notrace
