...
HD_PWD='C:/Users/gkash/Verilog files/four_bit_full_adder/four_bit_full_adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FBFA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FBFA.tcl -notrace
