...
HD_PWD='C:/Users/gkash/Verilog files/four_bit_full_adder/four_bit_full_adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FBFA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FBFA.tcl
