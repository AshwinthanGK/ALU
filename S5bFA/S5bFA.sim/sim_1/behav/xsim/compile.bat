...
REM
REM Generated by Vivado on Tue Jan 20 14:44:39 +0530 2026
...
echo "xvlog --incr --relax -prj tb_S5BFA_vlog.prj"
call xvlog  --incr --relax -prj tb_S5BFA_vlog.prj -log xvlog.log
