...
HD_PWD='C:/Users/gkash/Verilog files/2_bit_multiplier/2_bit_multiplier.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TwoBMult.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TwoBMult.tcl
