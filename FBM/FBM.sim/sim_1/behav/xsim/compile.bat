...
REM
REM Generated by Vivado on Fri Jan 16 13:59:04 +0530 2026
...
echo "xvlog --incr --relax -prj tb_FourBMult_vlog.prj"
call xvlog  --incr --relax -prj tb_FourBMult_vlog.prj -log xvlog.log
