...
HD_PWD='C:/Users/gkash/Verilog files/lecture1/lecture1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TopG.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TopG.tcl -notrace
