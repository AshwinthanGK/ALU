...
HD_PWD='C:/Users/gkash/Verilog files/lecture1/lecture1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TopG.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TopG.tcl
